...
#    поэтому устанавливаем только инструменты диагностики и бенчмаркинга.
...
pacman -S --noconfirm vulkan-tools libva-utils mesa-utils glmark2
...
# ==============================================================================
# >>> [СЦЕНАРИЙ Г] ГИБРИДНАЯ ГРАФИКА (AMD Radeon 680M + NVIDIA RTX 3050 Mobile) <<<
# ==============================================================================
# ⚠️ РЕКОМЕНДУЕМЫЙ СЦЕНАРИЙ ДЛЯ MAIBENBEN X17A

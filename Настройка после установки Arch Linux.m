...
# ------------------------------------------------------------------------------
# 🎯 Зачем: Установка утилит (Yay, Btrfs).
...
# Запускает куб принудительно на GPU #1. Если окно открылось — переключение работает!
...
# ------------------------------------------------------------------------------
# ЭТАП 12: ФИНАЛЬНАЯ ПРОВЕРКА СИСТЕМЫ
# ------------------------------------------------------------------------------

# 12.1 Очистка кэша пакетов
sudo pacman -Sc

# 12.2 Проверка сервисов
systemctl --user status pipewire
systemctl status ufw

# 12.3 Проверка оболочки
echo $SHELL

# 12.4 Создание финального снапшота (если Btrfs)

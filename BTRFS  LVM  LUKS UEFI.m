...
# 5. Разметка диска (GPT + UEFI) + LUKS + LVM
...
# ❗ ПЕРЕД ВЫПОЛНЕНИЕМ: Убедитесь, что 'sda1', 'sda2' заменены на правильные разделы!

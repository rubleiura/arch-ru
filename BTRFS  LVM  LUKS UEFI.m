...
ssed -i "s/MODULES=()/MODULES=(btrfs dm_mod dm_crypt)/" /etc/mkinitcpio.conf
# #------------------------------------------------------------------------------
...
grep "cryptdevice" /boot/grub/grub.cfg | head -1
...
# pacman -Sy --noconfirm vulkan-intel  # Раскомментируйте для CPU ≤ 11 gen
# #------------------------------------------------------------------------------
...
# Универсальная команда: добавляет модули, сохраняя существующие.
...
# ✅ Включает KMS (Kernel Mode Setting). Требуется для Wayland и гибернации.
# ✅ Безопасная замена всей строки с сохранением существующих параметров.
...
# ✅ Применяет все изменения: новые модули, хуки и конфиги modprobe.

...
# ❗ Хук 'resume' обязателен для корректной гибернации (должен быть ДО filesystems)
sed -i "s|^HOOKS=(.*)|HOOKS=(base systemd autodetect microcode modconf kms keyboard sd-vconsole block resume filesystems fsck)|" /etc/mkinitcpio.conf

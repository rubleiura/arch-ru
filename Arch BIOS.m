...
# • Для гибридной (AMD iGPU + NVIDIA dGPU): выполните ШАГ 1 + Сценарий Б + Сценарий В
# • Удалите # только перед командами, которые нужно выполнить
...
# ✅ Исправленный sed: корректно обрабатывает #MODULES=() и MODULES=(btrfs)
# ✅ Флаг -E включает расширенные регулярные выражения. Запускать один раз!
sed -i '/^MODULES=/ s/)$/ nvidia nvidia_modeset nvidia_uvm nvidia_drm)/' /etc/mkinitcpio.conf
# 📋 2. Добавить параметр ядра nvidia-drm.modeset=1
# ✅ Корректно сохраняет параметры из Блока 12 и добавляет новый.
...
# ✅ сохранение VRAM и службы гибернации NVIDIA
